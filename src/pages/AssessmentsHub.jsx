...
export default function AssessmentsHub() {
  ...
  return (
    <div className="min-h-screen font-display flex flex-col bg-background-dark text-white">
      <InternalNavbar />
      ...
      <main className="flex-1 px-4 lg:px-40 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className="w-full lg:w-64 flex flex-col gap-6">
            <div className="p-6 rounded-xl glow-violet glass-panel">
              <div className="flex flex-col mb-6">
                <h1 className="text-lg font-bold text-white">Quick Stats</h1>
              ...
              <div className="flex flex-col gap-1 mt-8">
                <div className="flex items-center gap-3 px-3 py-2 rounded-lg cursor-pointer transition-all text-white/70 hover:bg-white/5" onClick={() => navigate('/dashboard')}>
                ...
                <div className="flex items-center gap-3 px-3 py-2 rounded-lg cursor-pointer transition-all text-white/70 hover:bg-white/5" onClick={() => navigate('/career-paths')}>
                  <span className="material-symbols-outlined text-lg">star</span>
                  <p className="text-sm font-medium">Recommendations</p>
                </div>
                <div className="flex items-center gap-3 px-3 py-2 rounded-lg cursor-pointer transition-all text-white/70 hover:bg-white/5" onClick={() => navigate('/settings')}>
                  <span className="material-symbols-outlined text-lg">settings</span>
                  <p className="text-sm font-medium">Preferences</p>
                </div>
              </div>
              <button className="mt-8 w-full flex items-center justify-center gap-2 rounded-lg h-11 text-sm font-bold bg-white/5 border border-white/10 text-white hover:bg-white/10">
